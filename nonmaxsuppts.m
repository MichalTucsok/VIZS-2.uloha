...
%
% Non maxima funkcia na potlacenie a prahovanie bodov
% generovanych funkciou alebo detekciou rohu
%
% Pouzijeme funkciu   [r,c] = nonmaxsuppts(cim, radius, thresh, im)
%                                                    /
%                                                optional
%
...
%                                                             
% Vstupne argumenty
%            im    - obrazok z rohovými
%            radius - polomer, typicke hodnoty 1 az 3 pixely
%            thresh - prah
%            im     - Obrazové údaje, na tento obrazok su prekryte prahover
%            rohy a pouzijeme pri ladeni parametrov
% Funkcia vracia
%            r      - Suradnice rohovych bodov (budu celociselne)
%            c      - suradnice stlpcov rohovych bodov
